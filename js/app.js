...
function MapViewModel() {
  ...
  var venueMarkers = [];
  var defaultNeighborhood = "Chicago";
  ...
  function getInformation(placeData) {
    ...
    extraParams = "&limit=20&section=topPicks&day=any&time=any&locale=en&oauth_token=NWXW5QDQCTLR1AFR2X0CAZTDJQMYPI0OB1E4HELS2W2MDMNB&v=20150905";
